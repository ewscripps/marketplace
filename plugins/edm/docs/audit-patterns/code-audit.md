...
### P1 (9) -- fix before shipping (EDMV3, 2026-08-16, P2)
...
### P2 -- accept-p2-debt cluster (6 more) (EDMV3, 2026-08-16, P2)
...
### P2 -- regressions introduced by this session's own remediation (7) (EDMV3, 2026-08-16, P2)
...
### P2 -- correctness, concurrency and runtime hygiene (13) (EDMV3, 2026-08-16, P2)
...
### P2 -- test quality (7) (EDMV3, 2026-08-16, P2)
...
### P2 -- documentation, spec text and wiring (18) (EDMV3, 2026-08-16, P2)
...
### WORK ITEM 1 -- `--accept-p2-debt` (CA-423, CA-424, CA-425, CA-426, CA-427, CA-428, CA-429, CA-430, CA-431) (EDMV3, 2026-08-16, P2)
...
### WORK ITEM 2 -- regressions from this session's own remediation (EDMV3, 2026-08-16, P2)
...
### WORK ITEM 3 -- P1s outside the accept-p2-debt cluster (EDMV3, 2026-08-16, P2)
...
### WORK ITEM 4 onward -- P2 detail (EDMV3, 2026-08-16, P2)
...
### Stage 0 -- Decision gate (blocks Stage 1; human required) (EDMV3, 2026-08-16, P2)
...
### Stage 1 -- Quick, low-risk fixes from this session's own remediation (parallel, ~1 commit) (EDMV3, 2026-08-16, P2)
...
### Stage 2 -- The `--accept-p2-debt` cluster (ONE coordinated work item) (EDMV3, 2026-08-16, P2)
...
### Stage 3 -- Remaining P1s (parallel, file-independent) (EDMV3, 2026-08-16, P2)
...
### Stage 4 -- P2 batches (grouped by shared root cause; one commit each) (EDMV3, 2026-08-16, P2)
...
### Syntax / static (EDMV3, 2026-08-16, P2)
...
### Hook lint (CA-436 -- run this BEFORE enabling the blocking job) (EDMV3, 2026-08-16, P2)
...
### Test suites (EDMV3, 2026-08-16, P2)
...
### Lint / contract checks (EDMV3, 2026-08-16, P2)
...
### Integration / manual smoke (EDMV3, 2026-08-16, P2)
...
### Targeted re-audit (round 9) (EDMV3, 2026-08-16, P2)
