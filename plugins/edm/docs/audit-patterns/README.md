...
Neither warning status is a failure: `update-patterns` is called mid-phase by the audit and
implementation skills, so it warns and continues rather than aborting the phase.
