...
This agent always applies once the code-audit skill selects lens L3 for the round; lens selection (full vs. partial round) is decided by `skills/code-audit/SKILL.md`, not by this agent.
