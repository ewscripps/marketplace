...
Execute all phases in strict sequential order (DC0-DC8). Do not skip, reorder, or combine any phases. All approval gates require explicit confirmation before proceeding.
